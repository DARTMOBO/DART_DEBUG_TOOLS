...
{
 case 1:
 if (qwertyvalue[chan_] == 0 )  {button(typetable[chan_+page],valuetable[chan_+page],maxvalue[chan_],1); DmxSimple.write(dmxtable[chan_], maxvalue[chan_]*2);}// 
 ...
 case 0: 
   if (qwertyvalue[chan_] == 0 ) { button(typetable[chan_+page],valuetable[chan_+page],minvalue[chan_],1); DmxSimple.write(dmxtable[chan_], minvalue[chan_]*2); }
