// nota, se si vuole usare scale play-learn, la speed dovrebbe essere 1 o -1 non di più
...
// il detector cotinua a mandarmi in modalita'  diferenziata anche i modificatori collegati al'in analogico
/// perche'?
