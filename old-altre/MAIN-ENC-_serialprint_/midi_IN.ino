...
// if (numero > 0) numero = 1;
 ...
 qwertyvalue[i] =EEPROM.read(i+384+(numero*512));
  ...
  shifter.setAll(LOW); shifter.write();
     ...
     //test1();
       if ( auxx == 0) // aux viene impostato su 1 dalla void setup_mempos richamata sopra - alla riga 194 - se ÃƒÂ¨ presente un general mempos.
       { aux_preset();
     //   valuetable[0]=60;
...
*/
  ...
  if ( modetable[i] == 26) {general_mempos = i; auxx = 1;}
